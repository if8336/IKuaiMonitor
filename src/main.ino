...
void getMemoryUsage()
{
    if (getNetDataInfo("system.ram", netChartData))
    {
...
void getTemperature()
{
    if (getNetDataInfo("sensors.sensor_chip_coretemp-isa-0000_feature_package_id_0_subfeature_temp1_input_temperature",
                       netChartData))
    {
...
void setup()
{
    ...
    lv_obj_set_style_local_border_side(cpu_bar, LV_BAR_PART_INDIC, LV_STATE_DEFAULT,
                                       LV_BORDER_SIDE_LEFT | LV_BORDER_SIDE_TOP | LV_BORDER_SIDE_BOTTOM);
    ...
    lv_obj_set_style_local_border_side(mem_bar, LV_BAR_PART_INDIC, LV_STATE_DEFAULT,
                                       LV_BORDER_SIDE_LEFT | LV_BORDER_SIDE_TOP | LV_BORDER_SIDE_BOTTOM);
